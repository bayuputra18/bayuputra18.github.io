...
$email_pengirim = 'aku21278@gmail.com'; // Isikan dengan email pengirim
$nama_pengirim = $_POST['email']; // Isikan dengan nama pengirim
$email_penerima = $_POST['putrabayu0180@gmail.com']; // Ambil email penerima dari inputan form
...
$mail->Password = 'dmrpzkslgttrxdar'; // Isikan dengan Password email pengirim
$mail->Port = 465;
$mail->SMTPAuth = true;
$mail->SMTPSecure = 'ssl';
