        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navigation">
            <ul class="navbar-nav">
              ...
              <li class="nav-item"><a class="nav-link smooth-scroll" href="blog.php">Blog</a></li>
            </ul>
          </div>
        </div>
      </nav>
          ...
          <div class="page-header page-header-small" filter-color="green">
            ...
            <div class="container">
              <div class="content-center">
                <div class="cc-profile-image"><a href="#"><img src="images/IMG_8179.resized.JPG.png" alt="Image" /></a>
                </div>
                <div class="h2 title">Bayu Putra Herlambang</div>
                <p class="category text-white">Web Developer & Network Administrator</p><a
                  class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in"
                  style="color: #2E3440 !important;" data-aos-anchor="data-aos-anchor">Contact Me</a><a
                  class="btn btn-primary" href="data/cv.pdf" data-aos="zoom-in" style="color: #2E3440 !important;"
            ...
            <div class="section">
              <div class="container">
                <div class="button-container"><a class="btn btn-default btn-round btn-lg btn-icon"
                    style="color: #2E3440 !important;" href="#" rel="tooltip" title="Follow me on Facebook"><i
                      class="fa fa-facebook"></i></a><a class="btn btn-default btn-round btn-lg btn-icon"
                    style="color: #2E3440 !important;" href="https://t.me/dmtry18" rel="tooltip"
                    title="Contact me on Telegram"><i class="fa fa-telegram"></i></a><a
                    class="btn btn-default btn-round btn-lg btn-icon" style="color: #2E3440 !important;"
                    href="https://github.com/bayuputra18" rel="tooltip" title="Follow me on Github"><i
                      class="fa fa-github"></i></a><a class="btn btn-default btn-round btn-lg btn-icon"
                    style="color: #2E3440 !important;" href="#" rel="tooltip" title="Follow me on Instagram"><i
            ...
            <div class="row">
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
                  ...
                  <p>A fresh graduate who has the ability to repair network devices and computer equipment. Excellent at
                    Mikrotik, Cisco, Linux, and Server quite well.</a></p>
                </div>
              </div>
              <div class="col-lg-6 col-md-12">
                <div class="card-body">
        ...
        <div class="container">
          ...
          <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  <div class="progress-container progress-primary"><span class="progress-badge">Hardware and software
                      maintenance</span>
                    <!-- <div class="progress">
                ...
                <div class="col-md-6">
                  <div class="progress-container progress-primary"><span class="progress-badge">Server Linux
                      administrator</span>
                    <!-- <div class="progress">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="progress-container progress-primary"><span class="progress-badge">System and network
                      administration</span>
                    <!-- <div class="progress">
              ...
              <div class="nav-align-center">
                <ul class="nav nav-pills nav-pills-primary" role="tablist">
                  ...
                  <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#graphic-design" role="tablist"><i
                        class="fa fa fa-certificate" aria-hidden="true"></i></a></li>
            ...
            <div class="row">
              ...
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  ...
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus soluta adipisci molestias
                    dolorum, consequatur voluptatem mollitia voluptates ipsam ullam reprehenderit culpa, pariatur porro
                    tempora voluptate vitae, doloribus eligendi animi. Quam a velit suscipit nam iusto, provident fuga
                    dolorem labore rerum quidem facilis tenetur ea alias aut, dolorum vitae autem aliquam.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body cc-experience-header">
                  ...
                  <div class="h5">
                    <div class="h9">PT. Garuda Media Telematika</div>
                  </div>
                </div>
              </div>
              <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                <div class="card-body">
                  ...
                  <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis eius, ipsam iure consectetur repellat
                    quibusdam animi quos, nisi alias similique reiciendis possimus consequuntur minus, dolorem
                    perspiciatis? Id omnis quos, reiciendis incidunt sint debitis, libero maiores ullam, mollitia
                    aperiam cupiditate cum. Culpa voluptatem magnam fugiat fuga, eius animi blanditiis est saepe!
                  </p>
                </div>
              </div>
            </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
                    <div class="card-body">
                      ...
                      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequatur at odio, iste harum ipsum
                        provident sequi laborum eligendi, repellat incidunt eius, illum enim quas facere! Unde, corrupti
                        voluptates? Dolore voluptatem quaerat distinctio excepturi unde. Officiis reprehenderit ipsum,
                        exercitationem iure veniam, accusamus vitae quas commodi quibusdam maiores magni quam ab
                        debitis!</p>
                    </div>
                  </div>
                </div>
        ...
        <div class="carousel-inner">
                              ...
                              <div class="col-md-6">
                                <div class="card-body">
                                  <form method="POST" action="send.php">
                                    ...
                                    <div class="row mb-3">
                                      <div class="col">
                                        <div class="input-group"><span class="input-group-addon"><i
                                          ...
                                          <input class="form-control" style="position: static;" type="text" id="name"
                                    ...
                                    <div class="row mb-3">
                                      <div class="col">
                                        <div class="form-group">
                                          <textarea class="form-control" name="message" id="pesan"
                                    ...
                                    <div class="row">
                                      <div class="col">
                                        <button class="btn btn-primary" style="color: #DDE2EC !important;" type="submit"
                                          onclick="kirim" id="myBtn">Send</button>
                                      </div>
                                    </div>
                                  </form>
                                </div>
          ...
          <!-- <footer class="footer col-lg-12 col-md-12" style="background-color: #DDE2EC;">
            <div class="container text-center"><a class="cc-facebook btn btn-link" href="#"><i
                ...
                href="#"><i class="fa fa-telegram fa-2x " aria-hidden="true"></i></a><a
                class="cc-google-plus btn btn-link" href="#"><i class="fa fa-github fa-2x" aria-hidden="true"></i></a><a
                class="cc-instagram btn btn-link" href="instagram.com/bayherl_"><i class="fa fa-instagram fa-2x "
